    ...
    <div className="min-h-screen flex items-center justify-center px-4 py-8 -mt-16">
      <div className="max-w-md w-full">
        ...
        <div className="text-center mb-8 animate-fade-in">
          ...
          <h2 className="text-3xl font-bold heading-gradient">Create Account</h2>
          <p className="mt-2 text-gray-600">Join TaskFlow Pro to get started</p>
        </div>
        ...
        <div className="glass-card p-8 space-y-6 animate-slide-up">
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className={`input-custom w-full pl-10 pr-10 ${errors.confirmPassword ? 'border-red-500' : ''}`}
                  placeholder="********"
                />
                <button
                  type="button"
            ...
            <div className="flex items-center">
              ...
              />
              <label htmlFor="terms" className="ml-2 text-sm text-white-600">
                I agree to the{' '}
